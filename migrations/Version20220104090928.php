 ...
 */
final class Version20220104090928 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comments (id INT AUTO_INCREMENT NOT NULL, account_id INT DEFAULT NULL, game_id INT NOT NULL, created_at DATETIME NOT NULL, content LONGTEXT NOT NULL, up_votes INT NOT NULL, down_votes INT NOT NULL, INDEX IDX_5F9E962A9B6B5FBA (account_id), INDEX IDX_5F9E962AE48FD905 (game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE comments ADD CONSTRAINT FK_5F9E962A9B6B5FBA FOREIGN KEY (account_id) REFERENCES account (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE account CHANGE wallet wallet INT DEFAULT 0 NOT NULL');
    }
}
